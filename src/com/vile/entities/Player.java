 ...
 * Title: Player
 * 
 * @author Alex Byrd Date Updated: 3/13/2017
 *
 *         Keeps track of the players status. Such as position, ammo, health,
 *         etc ... and also adds ammo to the player and can harm the player as
 *         well.
 */
public class Player {
	// Typical values
