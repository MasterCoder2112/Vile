 ...
 * Title: Player
 * @author Alex Byrd
 * Date Updated: 3/13/2017
 *
 * Keeps track of the players status. Such as position, ammo, health, etc
 * ... and also adds ammo to the player and can harm the player as well.
 */
public class Player 
{
	//Typical values
    ...
    */
	public static void updateBuffs()
	{
	   ...
	   /*
	    * Each update, update how long its been since the player was last
	    * hurt so that the players face will display the correct expression.
	    */
		if(playerHurt > 0)
		{
			playerHurt--;
   ...
   /**
    * Hurts the player (if he/she is not in God mode) by a certain
    * amount sent in. Armor is also taken into account when dealing
