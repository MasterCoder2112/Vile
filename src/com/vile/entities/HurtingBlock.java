 ...
 * 
 *         Description: Hurting block can be either toxic waste, lava, or
 *         something new in the future, and this tracks where the item is, and
 *         when activated it can hurt the player every so many ticks if the
 *         player is on top of the block this item is on.
 */
public class HurtingBlock extends Item {
	...
	/**
	 * Activates the lava or toxic waste block to hurt the player if the player is
	 * on top of it and can be hurt.
	 */
	@Override
	public boolean activate() {
		...
		/*
		 * If player is not immune to this damage, is alive, and is not jumping over the
		 * block. Also has to be when the tick counter is reset to 0.
		 */
