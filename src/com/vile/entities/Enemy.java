...
public class Enemy extends Entity implements Comparable {
	 ...
	 * @param z
	 */
	public Enemy(double x, double y, double z, int ID, double rotation, int itemActivationID) {
	 ...
	 */
	public Enemy(int health, int armor, int ammo, int damage, int speed, double x, double y, double z, int ID,
	...
	public void enemyDeath() {
		...
		Game.corpses.add(new Corpse(xPos, zPos, -yPos * 10, ID, xEffects, zEffects, yEffects));
