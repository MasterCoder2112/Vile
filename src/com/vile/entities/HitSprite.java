 ...
 * Title: HitSprite
 * 
 * @author Alexander Byrd Date Created: 9/11/2017 (Not ominous at all)
 * 
 *         Description: Is a class that keeps track of the phase time and
 *         position of a hit sprite. Basically when a projectile hits a wall or
 *         other object this will display some textures to show it has hit a
...
public class HitSprite {
	...
	// Image rendered onto the screen.
	public Render spriteImage = null;
	...
	/**
	 * Ticks the sprites phaseTime so the animation looks realistic and also gets
	 * rid of the animation after the given amount of time is over.
	 */
	public void tick() {
		phaseTime++;
