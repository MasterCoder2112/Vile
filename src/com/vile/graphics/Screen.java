 ...
 * Title: Screen
 * @author Alex Byrd
 * Date Created: Long ago in February 2016
 * 
 * Description:
...
public class Screen
{
   ...
   /**
    * Set up the screen and the render3D object (what will be shown on 
    * the screen) with the width and height of the frame.
    * @param width
    * @param height
    */
